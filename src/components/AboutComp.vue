  ...
  methods: {
    colorTitle() {
      if (this.isDark == false) {
        return "text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-l from-green-700 via-cyan-800 to-cyan-900 md:text-text-4xl lg:text-7xl transition delay-150 duration-300 ease-in-out";
      } else {
        return "text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-l from-green-700 via-cyan-800 to-cyan-900 md:text-text-4xl lg:text-7xl transition delay-150 duration-300 ease-in-out";
      }
    },
